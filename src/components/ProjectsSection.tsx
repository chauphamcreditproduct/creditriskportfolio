  ...
  const projects: Project[] = [
    {
      ...
      technologies: [
        ...
        "Recovery Analysis", "Data Organization", "Financial Modeling",
        "Credit Risk Assessment", "Liquidity Analysis",
        "Chemical Industry Expertise", "Competitive Positioning Analysis",
        "Market Cyclicality Assessment", "Regional Market Analysis",
        "Debt Capacity Analysis", "Covenant Analysis",
        "Maturity Profile Analysis", "Business Profile Assessment",
        "Moody's Rating Methodology", "Historical Multiples Analysis",
        "Scenario Analysis", "Capital Structure Optimization",
        "Trend Analysis", "Quarterly vs Annual Comparison",
        "Margin Decomposition", "Cash Flow Sustainability Assessment",
        "Working Capital Analysis", "Operational Risk Analysis",
        "Market Risk Quantification", "Financial Policy Evaluation",
        "ESG Considerations", "Industry Comparative Analysis",
        "Distressed Multiples Application", "Recovery Rate Calculation"
      ],
    ...
    },
    {
      ...
      technologies: [
        ...
        "Ensemble Methods", "Gradient Boosting", "XGBoost Classifier", "XGBoost Regressor",
        "Classification Models", "Regression Models", "Feature Engineering",
        "Target Variable Creation", "Categorical Encoding", "Label Encoding", "OneHotEncoder",
        "Temporal Features", "Feature Selection", "Feature Importance",
        "Train-Validation-Test Split", "Cross-Validation", "Model Validation",
        "Classification Metrics", "Regression Metrics", "MAE", "RMSE", "R² Score",
        "Precision", "Recall", "F1-Score", "Accuracy",
        "Data Cleaning", "Data Preprocessing", "Missing Data Handling",
        "Data Validation", "Data Processing", "Outlier Detection",
        "IQR Method", "StandardScaler", "ColumnTransformer",
        "Exploratory Data Analysis (EDA)", "Descriptive Statistics",
        "Distribution Analysis", "Correlation Analysis", "Statistical Analysis",
        "Probability Distributions", "Statistical Testing", "Pearson Correlation",
        "Credit Risk Assessment", "Dynamic Credit Lines", "Risk Factors Analysis",
        "Collateral Analysis", "Financial Data Analysis", "Revenue Analysis",
        "Bank Balance Analysis", "Credit Utilization", "Payment Behavior Analysis",
        "Industry Analysis", "Segment Analysis", "Comparative Analysis", "Trend Analysis",
        "Risk-Reward Analysis", "Portfolio Analysis", "Decision Support",
        "Policy Implications", "Business Intelligence", "Risk Management",
        "Model Interpretation", "Performance Dashboards", "Business Reporting",
        "Machine Learning Pipelines", "Hyperparameter Tuning", "Error Analysis",
        "CRISP-DM Methodology", "Model Performance Benchmarking"
      ],
    ...
    },
    {
      ...
      technologies: [
        ...
        "Data Cleaning", "Data Preprocessing", "Missing Data Imputation",
        "Outlier Detection", "Data Splitting", "Cross-Validation",
        "Model Evaluation", "Model Diagnostics", "Decision Tree Visualization",
        ...
        "Statistical Testing", "Correlation Analysis", "Data Validation",
        "Credit Risk Modeling", "Predictive Modeling", "Risk Analytics",
        "Financial Data Analysis", "Risk Management Strategies", "Business Analytics",
        "Business Interpretation", "Business Reporting", "Risk-Reward Analysis",
        "Segment Analysis", "Comparative Analysis", "Decision Support"
      ],
    ...
    },
    {
      ...
      technologies: [
        ...
        "Data Aggregation", "Data Reshaping", "Index Manipulation",
        "Data Cleaning", "Data Preprocessing", "Feature Engineering",
        "Time Series Analysis", "Time Series Components", "Time Series Modeling",
        "Autoregressive (AR) Modeling", "Statistical Modeling", "Regression Models",
        "Model Evaluation", "Model Diagnostics", "Model Validation",
        "Exploratory Data Analysis (EDA)", "Statistical Analysis", "Statistical Testing",
        "Descriptive Statistics", "Correlation Analysis", "Distribution Analysis",
        "Visualization & Reporting", "Data Visualization", "Business Reporting",
        "Retail Analytics", "Sales Forecasting", "Seasonal Analysis",
        "Holiday Impact Analysis", "Economic Indicators", "Trend Analysis",
        "Inventory Optimization", "Business Intelligence", "Decision Support"
      ],
      ...
      notebookUrl: 'https://nbviewer.org/urls/huggingface.co/datasets/chauminhphamvn/123/resolve/main/Explore_Walmart_Sales_applying_Time_Series_Model.ipynb',
      imageUrl: '/api/placeholder/400/250',
